...
https://github.com/snehalathaR/Patent_Search/blob/main/patent_data.sql

Run the INSERT scripts [https://github.com/snehalathaR/Patent_Search/blob/main/patent_data.sql](url) in Spanner Studio Editor. This should populate the patents_data table we created in the previous step. This is the patent data we will use for matching with the user search text.
